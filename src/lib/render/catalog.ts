...
export const catalog = defineCatalog(schema, {
  components: {
    ...
    Cylinder: {
      props: z.object(mesh3DProps),
      description: "3D cylinder mesh. args: [radiusTop, radiusBottom, height, radialSegments].",
      example: {
        position: [0, 0, 0],
        color: "#88aa44",
        args: [1, 1, 2, 32],
    ...
    Torus: {
      props: z.object(mesh3DProps),
      description: "3D torus (donut) mesh. args: [radius, tube, radialSegments, tubularSegments].",
      example: {
        position: [0, 0, 0],
        color: "#aa44ff",
        args: [1, 0.4, 16, 100],
    ...
    DirectionalLight: {
      ...
      description: "Directional light like sunlight. Position sets direction, not location.",
  ...
  actions: {
    "posts.create": {
      ...
      description: "Create a new post via POST /api/v1/posts.",
    },
  },
});
