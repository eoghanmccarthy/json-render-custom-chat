...
export const webSearch = tool({
  description:
    "Search the web for current information on any topic. Use this when the user asks about something not covered by the specialized tools (weather, GitHub, Hacker News). Returns a synthesized answer based on real-time web data.",
